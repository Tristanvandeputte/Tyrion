...
Player::Player(double x,double y, string texture_location,EntityFactory* bullet_factory,ty::Entity* parent,shared_ptr<RenderWindow> window):ty::Player(x,y,bullet_factory,parent),texture_location(texture_location),window(window){
	//cout<<"FUKKKK"<<endl;
	sf::Texture texture;
	char cwd[1024];
