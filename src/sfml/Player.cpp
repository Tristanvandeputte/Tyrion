...
Player::Player(Vector position, string texture_location,EntityFactory* bullet_factory,ty::Entity* parent,shared_ptr<RenderWindow> window):ty::Player(position,bullet_factory,parent),texture_location(texture_location),window(window){
	//cout<<"FUKKKK"<<endl;
	sf::Texture texture;
	char cwd[1024];
